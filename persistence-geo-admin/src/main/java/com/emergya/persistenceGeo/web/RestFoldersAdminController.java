...
public class RestFoldersAdminController implements Serializable {
    ...
    public @ResponseBody Map<String, Object> moveFolderTo(@RequestParam("folderId") String folderId, @RequestParam("toFolder") String toFolder,
    ...
    public @ResponseBody FolderDto saveFolderByGroup(@PathVariable String groupId, @RequestParam("name") String name, @RequestParam("enabled") String enabled,
        ...
        try {
            ...
            // TODO isPlain should be folderType, but I haven't changed because
            // could be broke down
            try {
            ...
            if (StringUtils.isEmpty(parentFolder) || !StringUtils.isNumeric(parentFolder)) {
                return saveFolderBy(name, enabled, isChannel, folder_type, rootFolder != null ? rootFolder.getId() : null, null, idGroup);
            } else {
                return saveFolderBy(name, enabled, isChannel, folder_type, Long.decode(parentFolder), null, idGroup);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public @ResponseBody FolderDto saveFolder(@PathVariable String username, @RequestParam("name") String name, @RequestParam("enabled") String enabled,
            @RequestParam("isChannel") String isChannel, @RequestParam("isPlain") String isPlain,
            @RequestParam(value = "parentFolder", required = false) String parentFolder) {
        try {
            /*
            ...
            if (StringUtils.isEmpty(parentFolder) || !StringUtils.isNumeric(parentFolder)) {
                ...
                return saveFolderBy(name, enabled, isChannel, folder_type, rootFolder != null ? rootFolder.getId() : null, user.getId(), null);
            } else {
                return saveFolderBy(name, enabled, isChannel, folder_type, Long.decode(parentFolder), user.getId(), null);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private FolderDto saveFolderBy(String name, String enabled, String isChannel, Long folderTypeId, Long parentFolder, Long userId, Long groupId) {
    ...
    public @ResponseBody Map<String, Object> loadFolders(@PathVariable String username, @RequestParam(value = "filter", required = false) String filter) {
        Map<String, Object> result = new HashMap<String, Object>();
    ...
    public @ResponseBody Map<String, Object> loadFoldersByGroup(@PathVariable String idGroup, @RequestParam(value = "filter", required = false) String filter) {
        Map<String, Object> result = new HashMap<String, Object>();
        List<FolderDto> folders = null;
        try {
            /*
    ...
    public @ResponseBody Map<String, Object> loadFolders(@PathVariable String type, @PathVariable String style, @PathVariable String userOrGroup) {
        Map<String, Object> result = new HashMap<String, Object>();
        List<FolderDto> folders = null;
        try {
            /*
    ...
    public @ResponseBody Map<String, Object> renameFolder(@RequestParam("folderId") String folderId, @RequestParam("name") String name) {
        Map<String, Object> result = new HashMap<String, Object>();
        FolderDto folder = null;
        try {
            /*
    ...
    public @ResponseBody Map<String, Object> cloneUserContext(@RequestParam("originUser") String originUser, @RequestParam("targetUser") String targetUser,
        ...
        try {
             ...
             * .getAuthentication().getPrincipal()).getUsername();
             */
            Long originUserId = userAdminService.obtenerUsuario(originUser).getId();
            Long targetUserId = userAdminService.obtenerUsuario(targetUser).getId();
            folder = (FolderDto) foldersAdminService.copyUserContext(originUserId, targetUserId, merge != null ? new Boolean(merge) : false);
            result.put(SUCCESS, true);
        } catch (Exception e) {
            e.printStackTrace();
            result.put(SUCCESS, false);
    ...
    public @ResponseBody Map<String, Object> loadFoldersById(@PathVariable String idFolder, @RequestParam(value = "filter", required = false) String filter) {
        Map<String, Object> result = new HashMap<String, Object>();
    ...
    private void loadLayersInTree(Long folderId, Boolean isChannel, boolean recursive, List<Treeable> tree) {
        // add folders
    ...
    public @ResponseBody Map<String, Object> loadChannels(@RequestParam(value = "filter", required = false) String filter) {
        Map<String, Object> result = new HashMap<String, Object>();
        List<FolderDto> folders = null;
            ...
            if (filter != null) {
                ...
                if (filter.contains(HIDE_IPT_CHANNELS)) {
                    ...
                    for (FolderDto folder : previusFolders) {
                        if (folder.getIdFolderType() == null || folder.getIdFolderType().equals(FoldersAdminService.DEFAULT_FOLDER_TYPE)) {
    ...
    public @ResponseBody Map<String, Object> loadFoldersByZone(@RequestParam(value = "zone", required = true) String zoneId,
     ...
     * @return JSON file with success
     */
    @RequestMapping(value = "/persistenceGeo/loadFoldersByFoldersType", produces = { MediaType.APPLICATION_JSON_VALUE })
    public @ResponseBody Map<String, Object> loadFoldersByFoldersType(@RequestParam(value = "type", required = true) String typeId,
            @RequestParam(value = "parent", required = false) String parentId) {
        ...
        try {
            ...
            if (parentId == null) {
                ...
                // foldersAdminService.findByZone(new Long(zoneId), new
                // Long(parentId), Boolean.TRUE);
            }
            result.put(SUCCESS, true);
