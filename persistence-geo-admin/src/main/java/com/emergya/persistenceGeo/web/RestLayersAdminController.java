 ...
 */
@Controller
public class RestLayersAdminController extends RestPersistenceGeoController implements Serializable {
     ...
     */
    @RequestMapping(value = "/persistenceGeo/loadMapConfiguration", method = RequestMethod.GET, produces = { MediaType.APPLICATION_JSON_VALUE })
    public @ResponseBody Map<String, Object> loadMapConfiguration() {
     ...
     */
    @RequestMapping(value = "/persistenceGeo/updateMapConfiguration", method = RequestMethod.GET, produces = { MediaType.APPLICATION_JSON_VALUE })
    public @ResponseBody Map<String, Object> updateMapConfiguration(@RequestParam("bbox") String bbox, @RequestParam("iProj") String iProj,
    ...
    @RequestMapping(value = "/persistenceGeo/loadLayers/{username}", method = RequestMethod.GET, produces = { MediaType.APPLICATION_JSON_VALUE })
    ...
    @SuppressWarnings("unchecked")
    @RequestMapping(value = "/persistenceGeo/loadPublicLayers/{userId}", method = RequestMethod.GET, produces = { MediaType.APPLICATION_JSON_VALUE })
    public @ResponseBody Map<String, Object> loadPublicLayers(@PathVariable Long userId) {
        Map<String, Object> result = new HashMap<String, Object>();
        List<LayerDto> layers = null;
        try {

            // //TODO: Secure with logged user
            // String loggedUser = ((UserDetails)
            // SecurityContextHolder.getContext()
            // .getAuthentication().getPrincipal()).getUsername();
            //
            if (userId != null) {
     ...
     */
    @SuppressWarnings("unchecked")
    @RequestMapping(value = "/persistenceGeo/loadLayersByGroup/{groupId}", produces = { MediaType.APPLICATION_JSON_VALUE })
    ...
    public @ResponseBody Map<String, Object> getLayerTypeProperties(@PathVariable String layerType) {
        Map<String, Object> result = new HashMap<String, Object>();

        List<String> listRes = layerAdminService.getAllLayerTypeProperties(layerType);
    ...
    public @ResponseBody Map<String, Object> getLayerTypes() {
        Map<String, Object> result = new HashMap<String, Object>();
     ...
     * @return JSON file with layers
     */
    @RequestMapping(value = "/persistenceGeo/getLayerResource/{layerId}", method = RequestMethod.GET, produces = { MediaType.APPLICATION_JSON_VALUE })
    ...
    public @ResponseBody List<LayerDto> loadLayersGroup(@PathVariable String group) {
        List<LayerDto> layers = null;
        try {
            /*
             * //TODO: Secure with logged user String username = ((UserDetails)
     ...
     * @return JSON file with layers
     */
    @RequestMapping(value = "/persistenceGeo/loadLayersFolder/{folder}", method = RequestMethod.GET, produces = { MediaType.APPLICATION_JSON_VALUE })
    public @ResponseBody List<LayerDto> loadLayersFolder(@PathVariable String folder) {
        List<LayerDto> layers = null;
        try {
            /*
             * //TODO: Secure with logged user String username = ((UserDetails)
     ...
     * @return JSON file with layers
     */
    @RequestMapping(value = "/persistenceGeo/moveLayerTo", method = RequestMethod.POST, produces = { MediaType.APPLICATION_JSON_VALUE })
    public @ResponseBody Map<String, Object> moveLayerTo(@RequestParam("layerId") String layerId, @RequestParam("toFolder") String toFolder,
        ...
        try {
            ...
            if (toOrder != null) {
                Map<String, String> properties = layer.getProperties() != null ? layer.getProperties() : new HashMap<String, String>();
     ...
     */
    @RequestMapping(value = "/persistenceGeo/saveLayerSimpleProperties", produces = { MediaType.APPLICATION_JSON_VALUE })
    public @ResponseBody Map<String, Object> saveLayerSimpleProperties(@RequestParam("layerId") String layerId,
            @RequestParam(value = "name", required = false) String name, @RequestParam(value = "properties", required = false) String properties) {
        Map<String, Object> result = new HashMap<String, Object>();
        LayerDto layer = null;
        try {
            /*
            ...
            if (properties != null) {
                ...
                Map<String, String> layerProperties = layer.getProperties() != null ? layer.getProperties() : new HashMap<String, String>();
    ...
    public @ResponseBody LayerDto updateLayerByUser(@RequestParam("name") String name, @RequestParam("type") String type,
            @RequestParam(value = "layer_id") String layerId, @RequestParam(value = "properties", required = false) String properties,
            @RequestParam(value = "enabled", required = false) String enabled, @RequestParam(value = "order_layer", required = false) String order_layer,
            @RequestParam(value = "is_channel", required = false) String is_channel, @RequestParam(value = "publicized", required = false) String publicized,
            @RequestParam(value = "server_resource", required = false) String server_resource,
            @RequestParam(value = "folderId", required = false) String folderId, @RequestParam(value = "idFile", required = false) String idFile) {
        try {
            /*
             * //TODO: Secure with logged user String username = ((UserDetails)
             * SecurityContextHolder.getContext()
            ...
            // Copy layerData
            layer = copyDataToLayer(name, type, properties, enabled, order_layer, is_channel, publicized, server_resource, idFile, layer, folderId);
    ...
    public ModelAndView uploadFile(@RequestParam(value = "uploadfile") MultipartFile uploadfile) {
        ...
        if (uploadfile != null) {
            ...
            try {
                ...
                File temp = com.emergya.persistenceGeo.utils.FileUtils.createFileTemp("tmp", "xml");
    ...
    public @ResponseBody LayerDto saveLayerByUser(@PathVariable String username, @RequestParam("name") String name, @RequestParam("type") String type,
            @RequestParam(value = "properties", required = false) String properties, @RequestParam(value = "enabled", required = false) String enabled,
            @RequestParam(value = "order_layer", required = false) String order_layer, @RequestParam(value = "is_channel", required = false) String is_channel,
    ...
    public @ResponseBody LayerDto saveLayerByGroup(@PathVariable String idGroup, @RequestParam("name") String name, @RequestParam("type") String type,
            @RequestParam(value = "properties", required = false) String properties, @RequestParam(value = "enabled", required = false) String enabled,
            @RequestParam(value = "order_layer", required = false) String order_layer, @RequestParam(value = "is_channel", required = false) String is_channel,
            @RequestParam(value = "publicized", required = false) String publicized,
            @RequestParam(value = "server_resource", required = false) String server_resource,
        ...
        try {
            ...
            // Copy layerData
            layer = copyDataToLayer(name, type, properties, enabled, order_layer, is_channel, publicized, server_resource, idFile, layer, folderId, true);
     ...
     * @throws IOException
     */
    private LayerDto copyDataToLayer(String name, String type, String properties, String enabled, String order_layer, String is_channel, String publicized,
            String server_resource, String idFile, LayerDto layer, String folderId, Boolean update) {
        ...
        // Folder id
        if (!StringUtils.isEmpty(folderId) && StringUtils.isNumeric(folderId)) {
        ...
        if (idFile != null && loadFiles.containsKey(idFile)) {
     ...
     */
    private LayerDto copyDataToLayer(String name, String type, String properties, String enabled, String order_layer, String is_channel, String publicized,
            String server_resource, String idFile, LayerDto layer, String folderId) throws IOException {
        return copyDataToLayer(name, type, properties, enabled, order_layer, is_channel, publicized, server_resource, idFile, layer, folderId, false);
    }
    ...
    private static Map<String, String> getMapFromString(String properties) {
        ...
        if (properties.split(PROPERTIES_SEPARATOR) != null) {
            for (String property : properties.split(PROPERTIES_SEPARATOR)) {
                if (property != null && property.split(PROPERTIES_NAM_VALUE_SEPARATOR) != null && property.split(PROPERTIES_NAM_VALUE_SEPARATOR).length == 2) {
    ...
    public @ResponseBody void saveLayerByGroup(@PathVariable Long group, @RequestParam("name") String name, @RequestParam("type") String type,
    ...
    public @ResponseBody Map<String, Object> deleteLayerByLayerId(@PathVariable String layerId) {
        Map<String, Object> result = new HashMap<String, Object>();
        ...
        try {
            ...
            if (!(user.getAdmin() && layer.getPublicized() || user.getAuthorityId().equals(layer.getAuthId()))) {
            ...
            if (!geoserverService.deleteGeoServerLayer(workspace, layer.getNameWithoutWorkspace(), layer.getType(), layer.getTableName())) {
     ...
     */
    @RequestMapping(value = "/persistenceGeo/saveLayerTempLayer", produces = { MediaType.APPLICATION_JSON_VALUE })
    public @ResponseBody Map<String, Object> saveLayerTempLayer(@RequestParam("name") String name, @RequestParam("type") String type,
            @RequestParam(value = "properties", required = false) String properties, @RequestParam(value = "enabled", required = false) String enabled,
            @RequestParam(value = "order_layer", required = false) String order_layer, @RequestParam(value = "is_channel", required = false) String is_channel,
            @RequestParam(value = "publicized", required = false) String publicized,
            @RequestParam(value = "server_resource", required = false) String server_resource,
        ...
        try {
            // Copy layerData
            layer = copyDataToLayer(name, type, properties, enabled, order_layer, is_channel, publicized, server_resource, idFile, layer, folderId, null);
            result.put(SUCCESS, true);
        } catch (Exception e) {
            e.printStackTrace();
            result.put(SUCCESS, false);
